...
==========================================================
Author	: 		Rémi Kaeffer
Description : 	http://www.spoj.com/problems/CPTTRN6/
==========================================================
STATUS : AC in 0.16s
 */
...
public class Cpttrn6 {
	public static void main(String[] args) throws Exception {
		...
		while (n-- > 0) {
			...
			input.get(input.size() - 1)[3] = in.nextInt();
		}
		for (int i = 0; i < input.size(); i++) {
			for (int j = 1; j < input.get(i)[0] + ((input.get(i)[0]+1)*input.get(i)[2]) +1; j++) {
				for (int k = 1; k < input.get(i)[1] + ((input.get(i)[1]+1)*input.get(i)[3]) +1; k++) {
					if(k%(input.get(i)[3] + 1) == 0 && j%(input.get(i)[2] +1) == 0) {
						out.print('+');
					} else if(k%(input.get(i)[3] + 1) == 0) {
						out.print('|');
					} else if(j%(input.get(i)[2] +1) == 0) {
						out.print('-');
					} else {
						out.print('.');
					}
