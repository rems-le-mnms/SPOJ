...
==========================================================
Author	: 		Rémi Kaeffer
Description : 	http://www.spoj.com/problems/CPTTRN2/
==========================================================
STATUS : AC in 0.19s
 */
...
public class Cpttrn2 {
	public static void main(String[] args) throws Exception {
		...
		for (int i = 0; i < input.size(); i++) {
			for (int j = 0; j < input.get(i)[0]; j++) {
				for (int j2 = 0; j2 < input.get(i)[1]; j2++) {
					if(j==0 || j2==0 || j==input.get(i)[0]-1 || j2==input.get(i)[1]-1) {
						out.print("*");
						out.flush();
					} else {
						out.print(".");
